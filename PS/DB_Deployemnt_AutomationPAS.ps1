param([string]$RootPath="C:\Users\300915\Desktop\PAS\Release Candidates\PAS2016.1-Madagascar\Database\PASDBDeployment",[string]$DropLocation="C:\Users\300915\Desktop\PAS\Release Candidates\PAS2016.1-Madagascar\Database",[string]$BuildName=(Get-Date -format 'yyyyMMdd') +"_"+(Get-Date -format 'HHmm'),[string]$ENV="TEAM",[bool]$DeployChanges=$False,[string] $DbList="1,2,3,4",[bool]$ExcludeSynonym=$true)
