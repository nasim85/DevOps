param([string]$RootPath="C:\RevenueCycle\R2014.6\Care\Database\SSDP\ACH_DB_All",[string]$DropLocation="C:\RevenueCycle\R2014.6\Care\Database\SSDP",[string]$BuildName=(Get-Date -format 'yyyyMMdd') +"_"+(Get-Date -format 'HHmm'),[string]$ENV="CI",[bool]$DeployChanges=$False,[string] $DbList="15")
