...
param([string]$AssemblyCompany="Accretive Health, Inc.",[string]$AssemblyCopyright="Copyright © Accretive Health, Inc. 2016" ,[string]$AssemblyProduct="AHtoAccess")
...
$CompanyRegex = "assembly: AssemblyCompany"
$CopyRightRegex = "assembly: AssemblyCopyright"
$ProductRegex = "assembly: AssemblyProduct"
...
if($files)
{
    ...
    foreach ($file in $files) {
        ...
        $company='<Assembly: AssemblyCompany("'+$CompanyRegex+'")>'
        $copyright='<Assembly: AssemblyCopyright("'+$CopyRightRegex+'")>'
        $product='<Assembly: AssemblyCopyright("'+$ProductRegex+'")>'

        if($files.Extension -eq "cs")
        {
            $company='[Assembly: AssemblyCompany("'+$CompanyRegex+'")]'
            $copyright='[Assembly: AssemblyCopyright("'+$CopyRightRegex+'")]'
            $product='[Assembly: AssemblyCopyright("'+$ProductRegex+'")]'
        ...
        $filecontent=$filecontent -replace $VersionRegex, $NewVersion #| Out-File $file
