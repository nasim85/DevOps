param([string]$RootPath="C:\Users\300915\Desktop\RevenueCycle\DBAutomation\SSDP\ACH_DB_NonTran",[string]$DropLocation="C:\Users\300915\Desktop\RevenueCycle\DBAutomation\SSDP",[string]$BuildName=(Get-Date -format 'yyyyMMdd') +"_"+(Get-Date -format 'HHmm'),[string]$ENV="UAT",[bool]$DeployChanges=$False,[string] $DbList="15")
